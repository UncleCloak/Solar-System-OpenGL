...
Moon earthMoon(0.05f, 12, color(140, 140, 140), color(210, 210, 210), 1.1f, 8.0f, 0.18f, earth);
Moon moon1(0.02f, 12, color(140, 140, 140), color(210, 210, 210), 1.1f, 8.0f, 0.1f, earthMoon);
Moon moon2(0.005f, 12, color(140, 140, 140), color(210, 210, 210), 1.1f, 8.0f, 0.01f, moon1);
...
int main(int argc, char** argv) {
    ...
    glutCreateWindow("Moon Test Sample");
